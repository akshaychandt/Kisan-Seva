<?php 
   ...
   $officer=mysqli_query($conn,"SELECT complaints_tb.id,complaints_tb.complaint,complaints_tb.reply,login_tb.username FROM complaints_tb JOIN login_tb ON complaints_tb.user_id = login_tb.id WHERE complaints_tb.record_status = 1");
   ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      ...
      <script>
         ...
         $.ajax({
           ...
           data: {
            ...
            success: function(data){
               $( "#complaint_table" ).load( "complaints.php #complaint_table" );
