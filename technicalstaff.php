...
$staff=mysqli_query($conn,"SELECT * FROM `technicalstaff_tb` WHERE record_status='1'");
?>
...
<body>
    ...
    <!--===============================================================================================-->
      ...
      <input type="hidden" id="role" value="Technical_Staff">
      <!-- Add Modal-->
      <form method="post">
            ...
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel">Add Technical Staff</h5>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-primary" onclick="saveTechnicalStaffData()">Save</button>
                  </div>
               </div>
            </div>
         </div>
      ...
      <form method="post">
         <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel">Add TechnicalStaff</h5>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                     </button>
                  </div>
    ...
    <div class="main">
      <div class="container-fluid">
        <section id="main-content">
          <div class="row">
            <button style="float: right;" class="btn btn-success" onclick="populateAddModal()">Add Staff</button>
          </div>
                    <div class="row">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="TechnicalStaff_table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                              <?php
                                             while ($data=mysqli_fetch_assoc($staff)) {
                                          ?>
                                                <tr>
                                                    ...
                                                    <td><a href="#" class="btn btn-success" name="editStaff" onclick="editTechnicalStaff(<?php echo $data['id'];?>)">Edit</a>
                                                    <a href="#" class="btn btn-danger" name="deleteTechnicalStaff" onclick="deleteTechnicalStaffData(<?php echo $data['id'];?>)">Delete</a></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
   ...
   <!--===============================================================================================-->
      ...
      <!--===============================================================================================-->
    <script>
         function editTechnicalStaff(id) { 
           // App.initblockUI();
            var table    = 'technicalstaff_tb';
            $.ajax({
            ...
            success: function(data){ 
               ...
               $('#editModal .modal-title').html('Edit TechnicalStaff');                   
                  // App.initunblockUI(); 
              }
            },
    ...
    <!--===============================================================================================-->
    <script>
         function saveTechnicalStaffData() {
         ...
         $.ajax({
           ...
           data: {
            ...
            success: function(data){
               $( "#TechnicalStaff_table" ).load( "technicalstaff.php #TechnicalStaff_table" );
               $('#addModal').modal('hide');
      ...
      <!--===============================================================================================-->
      <script>
         function deleteTechnicalStaffData(id) {
               if(confirm("Are you sure to delete!")){
                     deleteTechnicalStaffDetails(id);
               }
         }
         function deleteTechnicalStaffDetails(id) {
            var table = 'technicalstaff_tb';
         $.ajax({
                     url:        'deleteData.php',
                     type:       'POST',
                     ...
                     success: function(data, status){
                           ...
                           $( "#TechnicalStaff_table" ).load( "agricultureofficer.php #TechnicalStaff_table" );
                     },
                     error : function(xhr, textStatus, errorThrown) {
                           if (xhr.status === 0) {
                                 alert('Not connected. Verify Network.');
