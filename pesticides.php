...
<html lang="en">
   ...
   <body>
            ...
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-primary" onclick="savePesticides()">Save</button>
                  </div>
               </div>
            </div>
         </div>
               ...
               <section id="main-content">
                  ...
                  <div class="row">
                     <div class="table-responsive">
                        <table class="table table-striped" id="pesticides_table">
                           <thead>
                              <tr>
                                 <th>#</th>
                                 <th>Pesticides</th>
                           ...
                           <tbody>
                              <?php
                                 while ($data=mysqli_fetch_assoc($pesticides)) {
                                 ?>
                              <tr>
      ...
      <!--===============================================================================================-->
      <script>
         function editPesticides(id) { 
           // App.initblockUI();
            var table    = 'pesticides_tb';
            $.ajax({
            url: 'getPesticides.php',
            type: 'POST',
            dataType:'',
            data: {
            'hiddenId'     : id,
            ...
            success: function(data){ 
               ...
               $('#pesticides').val(arraydata.pesticides);
               ...
               $('#addModal .modal-title').html('Edit Pesticides');                   
                  // App.initunblockUI(); 
              }
            },
      ...
      <script>
         ...
         $.ajax({
           ...
           data: {
            ...
            success: function(data){
               $( "#pesticides_table" ).load( "pesticides.php #pesticides_table" );
               $('#addModal').modal('hide');
      ...
      <script>
         ...
         function deletePesticidesDetails(id) {
            var table = 'pesticides_tb';
         $.ajax({
                     url:        'deleteData.php',
                     type:       'POST',
