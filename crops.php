<?php 
   ...
   $crops=mysqli_query($conn,"SELECT * FROM `crops_tb` WHERE record_status='1'");
   ?>
<!DOCTYPE html>
<html lang="en">
   <head>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                           <div class="form-group">
                              ...
                              <textarea class="form-control" id="crops" rows="6"></textarea>
                           </div>
                           <div class="form-group">
                              <label class="control-label col-md-5">Season</label>
                              <textarea class="form-control" id="season" rows="6"></textarea>
                           </div>
                           <div class="form-group">
                  ...
                  <div class="row">
                     <div class="table-responsive">
                        <table class="table table-striped" id="crops_table">
                           ...
                           <tbody>
                              <?php
                                 while ($data=mysqli_fetch_assoc($crops)) {
                                 ?>
                              <tr>
